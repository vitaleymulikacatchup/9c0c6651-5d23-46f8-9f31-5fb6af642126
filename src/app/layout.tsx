...
export const metadata: Metadata = {
  title: "ToyStore - Quality Toys for Kids of All Ages",
  description: "Discover the best selection of toys for children. Shop action figures, building blocks, games, and more. Fast shipping and great customer service.",
  keywords: "toys, kids toys, toy store, action figures, building blocks, board games, children toys",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "ToyStore - Quality Toys for Kids",
    description: "Browse our curated collection of quality toys for every age. Fast shipping, safety certified, and great prices.",
    type: "website",
    siteName: "ToyStore",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1766002654070-bi3q1pqq.jpg",
      alt: "ToyStore Featured Toys"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "ToyStore - Best Toys for Kids",
    description: "Quality toys, fast shipping, excellent customer service",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1766002654070-bi3q1pqq.jpg"]
  }
};
